...
function cmss(name, elem, cond, classMap) {
    var _a;
    ...
    var cmssElemObjects = Object.fromEntries(Object.entries(elem !== null && elem !== void 0 ? elem : {}).map(function (_a) {
        ...
        Object.assign(cmssElemObject, buildCondObjects(cmssElemObject.c, elemClass + conditionalSeparator, cmssElemObject));
        // Set n.elem.name:
    ...
    // eg. n.part.s
    Object.assign(cmssBaseObject, buildCondObjects(cmssBaseObject.c, baseName ? baseName + conditionalSeparator : "", cmssBaseObject));
    return cmssBaseObject;
}
exports.default = cmss;
...
function resolveNSSArg(builder, arg) {
    ...
    if (isNSSObject(arg)) {
        ...
        var cls = cmssObj.cls, mapped = cmssObj.mapped;
